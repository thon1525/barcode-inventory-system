                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <button class="btn btn-primary" type="button"
                                                            ...
                                                            data-bs-target="#ModalEdit{{ $itemtax->id }}">Edit</button>
                                                        {{-- create model for edit now --}}
                                                        <form
                                                            action="{{ route('tax.update', ['tax' => $itemtax->id]) }}"
                                                            autocomplete="off" method="POST">
                                                            {{-- @method('update') --}}
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal fade" id="ModalEdit{{ $itemtax->id }}"
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-floating">
                                                                                    <input name="nametax" required
                                                                                        type="text" id="nametax"
                                                                                        maxlength="20"
                                                                                        class="form-control"
                                                                                        value="{{ $itemtax->nametax }}"
                                                                                        id="floatingName"
                                                                                        name="tax_name"
                                                                                        placeholder="Product Name">
                                                                                    <label for="floatingName">Tax
                                                                                        Name</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-12 mt-md-3">
                                                                                <div class="form-floating">
                                                                                    <input name="price_tax" data-min_max
                                                                                        data-min="0" data-max="100"
                                                                                        data-toggle="just_number"
                                                                                        id="pricesetting" required
                                                                                        type="number"
                                                                                        class="form-control"
                                                                                        value="{{ $itemtax->price_tax * 100 }}"
                                                                                        id="floatingName"
                                                                                        name="pricetax"
                                                                                        placeholder="Product Name">
                                                                                    <label
                                                                                        for="floatingName">Price</label>
                                                                                </div>
                                                                            </div>
                                                                            <b></b>
                                                                        </div>
                                                        ...
                                                        <button type="button" class="btn btn-danger"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#ModalDelete{{ $itemtax->id }}">
                                                            Delete
                                                        </button>
                                                        <form enctype="multipart/form-data"
                                                            action="{{ route('tax.destroy', $itemtax->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="modal fade"
                                                                id="ModalDelete{{ $itemtax->id }}" tabindex="-1"
