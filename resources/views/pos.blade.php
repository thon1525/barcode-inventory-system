                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered" id="tbladdcat">
                                    ...
                                    <tbody id="bodycat">
                                                ...
                                                @foreach ($cart as $item)
                                                    @if ($product->id == $item->id)
                                                        <tr>
                                                            ...
                                                            <input type="hidden" class="row_id"
                                                                value="{{ $item->rowId }}" name="row_id">
                                                            ...
                                                            <td><input type="number" value="{{ $item->qty }}"
                                                                    name="product_qty" class="product_qty form-control">
                                                            </td>

                                                            <td><input type="number"
                                                                    value="{{ $product->product_price }}"
                                                                    name="product_price"
                                                                    class="product_price form-control"></td>
                                                            <td><input type="number" name="product_discount"
                                                                    value="0" placeholder="%"
                                                                    class="product_discount form-control"></td>
                                                            <td><input type="number" name="product_total"
                                                                    value="{{ $product->product_price * $item->qty }}"
                                                                    class="product_total form-control"></td>
                                                            <td><button type="button"
                                                                    class="remove btn btn-danger">Remove</button></td>
                                                        </tr>
                                                    @endif
                                                @endforeach
                                            @endif
                                        ...
                                        <tr>
                                            <td>
                                                <div class="select"> <select onmouseover="this.focus()"
                                                        data-live-search="true" name="product_id"
                                                        class="product_id form_select w-100 " id="">
                                                        <option value="0" selected>Select|Scan Barcode</option>
                                                        @foreach ($products as $product)
                                                            <option class="text-sm" value="{{ $product->id }}">
                                            ...
                                            <td><input type="number" name="product_qty"
                                                    class="product_qty form-control"></td>
                                        ...
                                        <tr>
                                            <td>Grand Total:</td>
                                            <td><input type="text" value="0" name="grand_total"
                                                    class="grand_total form-control"></td>
                                ...
                                <div class="row ">
                                    <div class="col-md-12 mb-5 mt-3">
                                        ...
                                        <div class="form-floating">
                                            <input required type="text" value="Customer name" required
                                                class="form-control customer_name" id="floatingName"
                                ...
                                <button type="button"
                                    class="btn col-2 btn-primary offset-lg-5 offset-md-5 offset-sm-5 offset-5"
                                    id="btnsaverow">Create order</button>
                            </div>
                        </div>
