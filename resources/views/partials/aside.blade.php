<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        {{-- add new Promotion --}}
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#promotion" data-bs-toggle="collapse"
                href="{{ url('/promotion') }}">
                <i class="bi bi-menu-button-wide"></i><span>Promotions</span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="promotion" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ url('/promotion') }}">
                        <i class="bi bi-circle"></i><span>Add promotions</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#stock-in-imort" data-bs-toggle="collapse" href="#">
                <i class="bi bi-menu-button-wide"></i><span>Final Price  </span><i
                    class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="stock-in-imort" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ url('/cost-products') }}">
                        <i class="bi bi-circle"></i><span>product with tax</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        {{-- <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#list_taxproduct" data-bs-toggle="collapse"
                href="#">
