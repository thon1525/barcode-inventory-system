...
class importproductController extends Controller
{
    ...
    public function funaddimportpro(Request $rq)
    {
        ...
        // total product
        DB::table('import_product')->select('namepro_import', 'proprice_import', 'progty_import', 'procate_import', 'prosupp_import', 'barcodepro_import', 'total_product', 'dateexpire', 'date_importpro')->insert([
    ...
    public function funstockin_import_update(Request $request)
    {
        ...
        $stockinendit = DB::table('stock_in_importpro')
            ...
            ->select(
                'stock_in_importpro.id_stock_in_import',
                'categories.catid',
    ...
    public function funimportupdatefunction(Request $request)
    {
        ...
        if ($request->file('product_change')) {
            ...
            $productimportupdate = DB::table('import_product')
                ...
                ->update([
                    'import_product.namepro_import' => $product_name,
            ...
            // if ($stock_in_importpro && $stock_in_importpro->image_productstockin == null)  {
