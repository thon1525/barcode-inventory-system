...
class ProductController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        DB::table('viewproduct')->select('product_name','category_id','supplier_id','product_price','product_qty','product_code')->insert([ 'product_name' => $product_name,'product_price' => $product_price,
        'category_id' => $category_id,'product_qty' => $product_qty, 'product_code' => $product_code, 'supplier_id' => $supplier_id,]);
...
// new function
// public function grid_view_edit(){
